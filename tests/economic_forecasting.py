...
#Forecast button
forecast_btn = '//*[@id="select_filter_form"]/div[2]/input[3]'
...
#START **************
#Click visualiser and get started
...
time.sleep(3)
driver.find_element_by_xpath(visualiser_btn).click()
...
time.sleep(2)
driver.find_element_by_xpath(forecast_btn).click()
